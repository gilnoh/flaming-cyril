...
%  entailment that 
  ...
  modular, reusable algorithm development.
  % that can store many kinds of information. 
  %, can be translated easily into features,
  %  and is applicable across languages. 
  We demonstrate that a pilot implementation of multi-level alignment
  with minimal features (open source) competes with
...
We also demonstrate our pilot implementation of this approach and show
evaluation results for English, German and Italian. It utilizes a
minimal number of analyzers, coupled with a set of basic
...
on the basis of anonymized customer interactions data (Eichler et
