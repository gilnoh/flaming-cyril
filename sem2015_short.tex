...
% Gil, Sebastian, Vered, Ido, Vivi, Kathrin, Lili, Meni 
 ...
 \author[4]{\authorcr \textbf{Vivi Nastase} (\texttt{\small nastase@fbk.eu})} % Vivi explicitly wanted her name as this 
...
score.
%Recall that we use WordNet and VerbOcean as knowledge sources
%for the Lexical Aligner, Meteor for the Paraphrase Aligner, and
%finally the Identical Lemma Aligner.
Note that the alignments can link
...
%We gratefully acknowledge partial funding by the European Commission
%(project EXCITEMENT (FP7 ICT-287923)).
This work was partially supported by the EC-funded project EXCITEMENT
(FP7ICT-287923). 
