...
\begin{abstract}
  ...
  {\em multi-level alignments} as a general representation to
  store information relevant for deciding entailment.
  % that can store many kinds of information. 
  %, can be translated easily into features,
  %  and is applicable across languages. 
  We demonstrate that a simple open-source, pilot implementation
